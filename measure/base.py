...
Source: source code"""
        ...
        self.ModuleVars = copy.deepcopy(MeasureClass.ModuleVars)
        self.ModuleConsts = copy.deepcopy(MeasureClass.ModuleConsts)
        self.Sys = Sys
        self.Name = Name
...
Source: source code"""
        ...
        self.ModuleVars = copy.deepcopy(MeasureAvgClass.ModuleVars)
        self.ModuleConsts = copy.deepcopy(MeasureAvgClass.ModuleConsts)        
        del self.Avg
        self.Filter = Filter
    ...
    def PreLoad(self):
        ...
        if hasattr(self, "Hist"):
            self.ModuleConsts += ["HistNBin"]
            self.ModuleVars += ["HistMin", "HistMax", "HistBin", "HistiBin", 
                                "HistCount", "Hist"]
