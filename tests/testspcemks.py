...
### Testing for SPCE potential in SIM suite.
### coded by MSS
...
AtomTypeO = sim.chem.AtomType("O", Mass = 2.6559E-26, Charge = -0.8476, Color = (1,0,0))
AtomTypeH = sim.chem.AtomType("H", Mass = 1.6735e-27, Charge = 0.4238, Color = (0,1,0))
...
Pos = np.array([[0.00000e-10,  0.00000e-10,  0.00000e-10],
                [0.81649e-10,  0.57736e-10,  0.00000e-10], 
                [-0.81649e-10,  0.57736e-10,  0.00000e-10]], dtype=float)
#add rigid bonds
...
World = sim.chem.World([MolType], Dim = 3, Units = sim.units.MKSUnits)

#make a system that exists in this world
SysName = "testmdspcemks"
